...
export const validateBody = (validations: ValidationChain[]) => {
  return async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      throw ApiError.validation('Invalid request body', { errors: errorMessages });
    } catch (error) {
      next(error);
    }
  };
...
export const validateQuery = (validations: ValidationChain[]) => {
  return async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      throw ApiError.validation('Invalid query parameters', { errors: errorMessages });
    } catch (error) {
      next(error);
    }
  };
...
export const validateParams = (validations: ValidationChain[]) => {
  return async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      throw ApiError.validation('Invalid path parameters', { errors: errorMessages });
    } catch (error) {
      next(error);
    }
  };
