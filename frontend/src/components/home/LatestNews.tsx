...
export function LatestNews() {
  const { articles, loading, error } = useHomeData();
    ...
    return (
      <section className="py-20 bg-muted/30" aria-labelledby="news-title">
        <div className="container-custom text-center">
          <h2 id="news-title" className="font-ubuntu text-3xl font-bold text-destructive">
            Oups !
          </h2>
  ...
  const displayArticles = safeArticles.slice(0, 3);
