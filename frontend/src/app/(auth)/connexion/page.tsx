      ...
      <div className="hidden lg:flex flex-1 items-center justify-center bg-gradient-to-br from-primary/5 to-secondary/5 p-8">
        ...
        >
          ...
          <div className="absolute bottom-4 left-0 right-0 text-center text-muted-foreground/60 text-sm font-light">
            <p>Bienvenue sur Youth Computing</p>
            <p className="text-xs mt-1">La plateforme qui vous accompagne</p>
          </div>
        </motion.div>
      </div>
          ...
          <div className="text-center space-y-3 pt-2">
            ...
            <p className="text-sm">
              <Link
                ...
                className="text-muted-foreground/60 hover:text-secondary transition-colors hover:underline underline-offset-2"
              >
                Mot de passe oublié ?
              </Link>
            </p>
