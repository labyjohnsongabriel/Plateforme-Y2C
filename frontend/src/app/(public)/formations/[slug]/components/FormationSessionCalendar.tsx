...
import type { FormationSession } from '@/types';

interface FormationSessionCalendarProps {
  sessions: FormationSession[];
}

export function FormationSessionCalendar({ sessions }: FormationSessionCalendarProps) {
