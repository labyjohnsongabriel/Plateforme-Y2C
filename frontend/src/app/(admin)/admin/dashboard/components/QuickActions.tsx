// app/(admin)/admin/dashboard/components/QuickActions.tsx
...
export function QuickActions() {
  ...
  const actions: QuickAction[] = [
    ...
    },
    {
      ...
      href: '/admin/messages',
      color: 'bg-rose-500/10 text-rose-500 border-rose-500/20 hover:bg-rose-500/20',
    },
    {
          ...
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 lg:grid-cols-4">
            {actions.map((action, index) => (
              <motion.button
                ...
                className={cn(
                  'flex flex-col items-center justify-center gap-1.5 rounded-lg border p-3 text-center transition-all hover:shadow-md',
                  action.color
                )}
              >
